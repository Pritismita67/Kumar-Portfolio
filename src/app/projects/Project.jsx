...
const PROJECTS = [
  ...
  },
  {
    ...
    challenge:
      "Project Visual Overview: Explore the spiritual design language and user interface",
    solution:
  ...
  },
 {
  ...
  },
  {
    ...
    type: "mobile",
    title: "ToletGlobe.in",
    tagline: "Revolutionizing Property Searchfor Modern India",
  ...
  },
  {
    ...
    tagline: "Lightweight Chat Interface, Built forStudent Success, Revolutionizing Property Search for Modern India",
    category: "Chat Interface Design",
    year: "2024",
    status: "Live",
    tags: ["Figma", "Canva","Stitch"],
    coverImage: "/kirasnm.png",
    images: ["/Pink Kiran Foundation 1.png", "/Pink Kiran Foundation 2.png", "/Pink Kiran Foundation 3.png", "Pink Kiran Foundation 4.png", "Pink Kiran Foundation 5.png","Pink Kiran Foundation 6.png","Pink Kiran Foundation 7.png","Pink Kiran Foundation 8.png","Pink Kiran Foundation 9.png","Pink Kiran Foundation 10.png","Pink Kiran Foundation 11.png","Pink Kiran Foundation 12.png","Pink Kiran Foundation 13.png","Pink Kiran Foundation 14.png","Pink Kiran Foundation 15.png","Pink Kiran Foundation 16.png","Pink Kiran Foundation 17.png","Pink Kiran Foundation 18.png","Pink Kiran Foundation 19.png","Pink Kiran Foundation 20.png","Pink Kiran Foundation 21.png","Pink Kiran Foundation 22.png","Pink Kiran Foundation 23.png","Pink Kiran Foundation 24.png","Pink Kiran Foundation 25.png","Pink Kiran Foundation 26.png"],
    description:
...
function TravellingBorder({ color, width, height, radius = 22 }) {
  ...
  useEffect(() => {
    ...
    function pointAt(d) {
      ...
      rem -= segTop;
      if (rem < arcLen) {
        const a = -Math.PI / 2 + (rem / radius);
        return { x: width - radius + Math.cos(a) * radius, y: radius + Math.sin(a) * radius };
      }
      rem -= arcLen;
      if (rem < segRight) return { x: width, y: radius + rem };
      rem -= segRight;
      if (rem < arcLen) {
        const a = 0 + (rem / radius);
        return { x: width - radius + Math.cos(a) * radius, y: height - radius + Math.sin(a) * radius };
      }
      rem -= arcLen;
      ...
      if (rem < arcLen) {
        const a = Math.PI / 2 + (rem / radius);
        return { x: radius + Math.cos(a) * radius, y: height - radius + Math.sin(a) * radius };
      }
      rem -= arcLen;
    ...
    function draw() {
      ...
      // 1. Static visible border always drawn first
      rrPath();
      ...
      for (let i = 0; i <= tailCount; i++) {
        ...
        if (i === tailCount) {
          ...
          const hex = Math.round(alpha * 0.9 * 255).toString(16).padStart(2, "0");
          ctx.fillStyle = `${color}${hex}`;
        }
        ctx.fill();
      }

      // 3. Soft glow halo at the tip
...
/* Wrapper that measures itself and renders the canvas on top */
      ...
      <style>{`
        ...
        .pr-card:hover {
          ...
          box-shadow: 0 24px 64px rgba(0,0,0,0.55),
                      0 0 0 0.5px rgba(167,139,250,0.22) inset,
                      0 0 90px rgba(124,58,237,0.11);
        }
        @keyframes cardUp {
        ...
        .pr-card:hover .card-img { transform: scale(1.07); }
        .card-img-overlay {
          position: absolute; inset: 0;
          background: linear-gradient(to bottom, transparent 30%, rgba(10,5,22,0.65) 100%);
          pointer-events: none;
        }
        .card-img-accent { position: absolute; top: 0; left: 0; right: 0; height: 3px; }
        .card-num-badge {
        ...
        .card-title {
          ...
          color: #ede9fe; margin: 0 0 7px; line-height: 1.2;
        }
        ...
        .ctag {
          font-size: 10px; letter-spacing: .1em; color: rgba(167,139,250,0.65);
          background: rgba(124,58,237,0.09); border: 1px solid rgba(167,139,250,0.18);
        ...
        .card-btn:hover {
          border-color: rgba(167,139,250,0.55); background: rgba(124,58,237,0.18);
          color: #fff; transform: translateX(3px); box-shadow: 0 0 20px rgba(124,58,237,0.25);
        }
        ...
        .modal-close:hover {
          background: rgba(124,58,237,0.35); border-color: rgba(167,139,250,0.8); color: #fff;
        ...
        .gal-arrow:hover {
          background: rgba(124,58,237,0.45); border-color: rgba(167,139,250,0.7);
        ...
        .modal-divider {
          width: 100%; height: 0.5px; flex-shrink: 0;
        ...
        @media (max-width: 600px) {
          ...
          .modal-backdrop { padding: 70px 10px 16px; }
        }
        ...
        .mbadge {
          ...
          background: rgba(124,58,237,0.12); color: rgba(167,139,250,0.9);
        }
        ...
        .mstatus {
          ...
          padding: 3px 10px; border-radius: 999px;
          background: rgba(16,185,129,0.08); border: 0.5px solid rgba(16,185,129,0.3); color: #6ee7b7;
        }
        .modal-title {
          font-family: 'Cormorant Garamond', serif;
          font-size: clamp(1.7rem, 4vw, 2.5rem); font-weight: 400; color: #ede9fe;
        ...
        .mtag {
          font-size: 10.5px; letter-spacing: .08em; color: rgba(167,139,250,0.7);
          background: rgba(124,58,237,0.08); border: 0.5px solid rgba(167,139,250,0.18);
          border-radius: 7px; padding: 4px 11px;
        }
        .modal-overview {
          background: rgba(255,255,255,0.03); border: 0.5px solid rgba(167,139,250,0.12);
          border-radius: 12px; padding: 18px 20px; margin-bottom: 14px;
        }
        .sec-label {
          font-size: 8.5px; letter-spacing: .3em; text-transform: uppercase;
          color: rgba(167,139,250,0.7); margin-bottom: 8px;
        }
        ...
        .modal-section {
          background: rgba(255,255,255,0.025); border: 0.5px solid rgba(167,139,250,0.1);
        ...
        .cta-a {
          ...
          font-family: 'Syne', sans-serif; font-size: 12px; font-weight: 600; letter-spacing: .07em;
          text-decoration: none; transition: all 0.25s; cursor: pointer;
        }
        .cta-primary {
          background: rgba(124,58,237,0.7); color: #fff;
          border: 0.5px solid rgba(167,139,250,0.5); backdrop-filter: blur(10px);
          box-shadow: 0 0 18px rgba(124,58,237,0.35), inset 0 0 0 0.5px rgba(255,255,255,0.08);
        }
        .cta-primary:hover {
          transform: translateY(-2px); background: rgba(124,58,237,0.85);
          box-shadow: 0 0 32px rgba(124,58,237,0.55), inset 0 0 0 0.5px rgba(255,255,255,0.12);
        }
        .cta-ghost {
          background: rgba(255,255,255,0.04); color: rgba(200,185,255,.75);
          border: 0.5px solid rgba(167,139,250,.2); backdrop-filter: blur(8px);
        }
        .cta-ghost:hover {
          border-color: rgba(167,139,250,.5); background: rgba(124,58,237,.12);
          color: #fff; transform: translateY(-2px); box-shadow: 0 0 16px rgba(124,58,237,0.2);
        }
      `}</style>
          ...
          {PROJECTS.map((p, i) => (
            ...
            >
              <div className="card-img-wrap" style={{
                aspectRatio: p.type === "mobile" ? "9/16" : p.type === "pdf" ? "3/4" : "16/9"
              }}>
                <div className="card-img-accent" style={{ background: `linear-gradient(90deg, ${p.color}, transparent)` }} />
                <div className="card-img-placeholder">{p.number}</div>
                <img
                  src={p.coverImage} alt={p.title} className="card-img" loading="lazy"
                  onError={(e) => { e.currentTarget.style.display = "none"; }}
                />
                <div className="card-img-overlay" />
                <span className="card-num-badge">{p.number}</span>
        ...
        >
          <ModalWithBorder color={selected.color}>
            <div className="modal-box" role="dialog" aria-modal="true">
              ...
              <div className="modal-top-bar" style={{
                background: `linear-gradient(90deg, transparent, ${selected.color}ee, rgba(167,139,250,1), ${selected.color}ee, transparent)`
              }} />
              ...
              <div className="modal-gallery">
                {selected.type === "pdf" ? (
                  ...
                  <>
                    <div className="mgal-placeholder">{selected.number}</div>
                    {selected.images.map((src, idx) => (
                      <img
                        key={idx}
                        src={src}
                        alt={`${selected.title} screenshot ${idx + 1}`}
                        className={`mgal-img${imgIndex === idx ? " show" : ""}`}
                        loading="lazy"
                      />
                    ))}
